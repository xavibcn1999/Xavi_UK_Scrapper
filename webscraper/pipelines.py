            ...
            try:
                ...
                <html>
                  <body>
                    ...
                    <p><strong>URL eBay en Edge:</strong> <a href="microsoft-edge:{ebay_url}">microsoft-edge:{ebay_url}</a></p>
                    <p><strong>URL Amazon en Edge:</strong> <a href="microsoft-edge:{amazon_url}">microsoft-edge:{amazon_url}</a></p>
